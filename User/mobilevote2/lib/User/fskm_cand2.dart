...
class FskmCand2 extends StatefulWidget {
  const FskmCand2({Key? key}) : super(key: key);

  @override
  _FskmCand2State createState() => _FskmCand2State();
}

class _FskmCand2State extends State<FskmCand2> {
