...
class FskmCand1 extends StatefulWidget {
  const FskmCand1({Key? key}) : super(key: key);

  @override
  _FskmCand1State createState() => _FskmCand1State();
}

class _FskmCand1State extends State<FskmCand1> {
      ...
      btnOkOnPress: () {
        FirebaseFirestore.instance
          ...
          if (!users.contains(user?.email)) {
            print("Here");
            await reference
                .add({"candidate": "candidate2", "voterEmail": user?.email});
